...
const RootStyle = styled(motion.div)(({ theme }) => ({
  ...
  backgroundImage: 'url(/static/overlay.svg), url(/static/consulting/hero.webp)',
  ...
  return (
    <RootStyle initial="initial" animate="animate" variants={varWrapEnter}>
      <Container maxWidth="lg" sx={{ position: 'relative', height: '100%' }}>
        <ContentStyle>
          <TextAnimate text="Ready" sx={{ color: 'primary.main' }} variants={varFadeInRight} />
          <br />
          <Box sx={{ display: 'inline-flex', color: 'common.white' }}>
            <TextAnimate text=" to" sx={{ mr: 2 }} />
            <TextAnimate text="achieve" sx={{ mr: 2 }} />
            <TextAnimate text="your" sx={{ mr: 2 }} />
            <TextAnimate text="goals?" />
          </Box>
        </ContentStyle>
      </Container>
    </RootStyle>
